        ...
        <div className="ayur-bgcover ayur-about-sec">
          <div className="container fluid about-us">
            <div className="row">
              ...
              <div className="col-lg-6 col-md-12 col-sm-12">
                <div className="ayur-heading-wrap ayur-about-head ayur-heading-wrap">
            ...
            <div className="row ayur-about-head ayur-heading-wrap">
              <p>
              ...
              <h5 className="pt-4">The Journey :The Dream …</h5>
              <p>
            ...
            <div className="row ayur-about-head ayur-heading-wrap">
              ...
              <h5 className="pt-4">The Future –</h5>
              <p>
