...
const AddMetabolicDisorders = () => {
  ...
  // Form state for Metabolic Disorders
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = "https://mahadevaaya.com/trilokayurveda/trilokabackend/api/ourfocus-metabolicdisorders-items/";
      ...
      if (!response.ok) {
        ...
        throw new Error((errorData && errorData.message) || "Failed to add metabolic disorder item");
      }
      ...
      if (result.success) {
        setMessage("Metabolic disorder item added successfully!");
        setVariant("success");
        setShowAlert(true);
        clearForm();
        ...
        throw new Error(result.message || "Failed to add metabolic disorder item");
      }
      
    } catch (error) {
      // FAILURE PATH
      console.error("Error adding metabolic disorder item:", error);
      ...
      <div className="dashboard-container">
        ...
        <div className="main-content">
          ...
          <Container fluid className="dashboard-body dashboard-main-container">
            <h1 className="page-title">Add Metabolic Disorder</h1>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <div className="d-flex gap-2 mt-3">
                ...
                >
                  {isSubmitting ? "Submitting..." : "Add Metabolic Disorder"}
                </Button>
...
export default AddMetabolicDisorders;