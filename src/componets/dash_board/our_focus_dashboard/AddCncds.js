...
const AddCncds = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = "https://mahadevaaya.com/trilokayurveda/trilokabackend/api/ourfocus-othercndns-items/";
      ...
      if (!response.ok) {
        ...
        throw new Error((errorData && errorData.message) || "Failed to add CNCD item");
      }
      ...
      if (result.success) {
        setMessage("CNCD item added successfully!");
        setVariant("success");
        setShowAlert(true);
        clearForm();
        ...
        throw new Error(result.message || "Failed to add CNCD item");
      }
      
    } catch (error) {
      // FAILURE PATH
      console.error("Error adding CNCD item:", error);
      ...
      <div className="dashboard-container">
        ...
        <div className="main-content">
          ...
          <Container fluid className="dashboard-body dashboard-main-container">
            <h1 className="page-title">Add CNCD</h1>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <div className="d-flex gap-2 mt-3">
                ...
                >
                  {isSubmitting ? "Submitting..." : "Add CNCD"}
                </Button>
