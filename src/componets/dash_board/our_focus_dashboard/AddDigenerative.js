...
const AddDegenerative = () => {
  ...
  // Form state for Degenerative Disorders
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = "https://mahadevaaya.com/trilokayurveda/trilokabackend/api/ourfocus-degenerativedisorders-items/";
      ...
      if (!response.ok) {
        ...
        throw new Error((errorData && errorData.message) || "Failed to add degenerative disorder item");
      }
      ...
      if (result.success) {
        setMessage("Degenerative disorder item added successfully!");
        setVariant("success");
        setShowAlert(true);
        clearForm();
        ...
        throw new Error(result.message || "Failed to add degenerative disorder item");
      }
      
    } catch (error) {
      // FAILURE PATH
      console.error("Error adding degenerative disorder item:", error);
      ...
      <div className="dashboard-container">
        ...
        <div className="main-content">
          ...
          <Container fluid className="dashboard-body dashboard-main-container">
            <h1 className="page-title">Add Degenerative Disorder</h1>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <div className="d-flex gap-2 mt-3">
                ...
                >
                  {isSubmitting ? "Submitting..." : "Add Degenerative Disorder"}
                </Button>
...
export default AddDegenerative;