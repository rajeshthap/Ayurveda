...
const AddOwnManufacturing = () => {
  ...
  // Form state for Own Manufacturing
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = "https://mahadevaaya.com/trilokayurveda/trilokabackend/api/our-focus-own-manufacturing-items/";
      ...
      if (!response.ok) {
        ...
        throw new Error((errorData && errorData.message) || "Failed to add own manufacturing item");
      }
      ...
      if (result.success) {
        setMessage("Own manufacturing item added successfully!");
        setVariant("success");
        setShowAlert(true);
        clearForm();
        ...
        throw new Error(result.message || "Failed to add own manufacturing item");
      }
      
    } catch (error) {
      // FAILURE PATH
      console.error("Error adding own manufacturing item:", error);
      ...
      <div className="dashboard-container">
        ...
        <div className="main-content">
          ...
          <Container fluid className="dashboard-body dashboard-main-container">
            <h1 className="page-title">Add Own Manufacturing</h1>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <div className="d-flex gap-2 mt-3">
                ...
                >
                  {isSubmitting ? "Submitting..." : "Add Own Manufacturing"}
                </Button>
...
export default AddOwnManufacturing;