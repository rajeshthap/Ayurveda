...
const AddTestinomial = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = "https://mahadevaaya.com/trilokayurveda/trilokabackend/api/testimonials-items/";
      ...
      if (!response.ok) {
        ...
        throw new Error((errorData && errorData.message) || "Failed to add testimonial");
      }
